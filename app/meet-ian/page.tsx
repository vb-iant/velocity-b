...
export const metadata: Metadata = {
  title: "Meet Ian | Velocity-B",
  description:
    "Book time with Ian Truscott — a discovery call, or whatever's on your mind. Pick a slot below and we'll confirm by Google Meet.",
};

export default function MeetIanPage() {
  return (
    <main>
      {/* Hero */}
      ...
      <section className="mx-auto max-w-[1180px] border-t border-hair px-12 py-20">
        <div className="grid grid-cols-1 items-start gap-16 md:grid-cols-2">
          ...
          <div className="sticky top-8 border-t-[6px] border-blue bg-[#fafbfd] px-8 py-9">
            <HubspotMeetings meetingUrl="https://meetings-eu1.hubspot.com/ian-truscott?embed=true" />
